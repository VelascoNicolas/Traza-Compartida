...
public class EmpleadoController extends BaseControllerImp<Empleado, EmpleadoDTO, Long, EmpleadoFacadeImpl> {
    ...
    public ResponseEntity<?> getAll(@PathVariable Long id) {
        try {
            return facade.getAllImagesByEmpleadoId(id); // Llama al método del servicio para obtener todas las imágenes
        } catch (Exception e) {
            e.printStackTrace();
            return null; // Manejo básico de errores, se puede mejorar para devolver una respuesta más específica
        }
