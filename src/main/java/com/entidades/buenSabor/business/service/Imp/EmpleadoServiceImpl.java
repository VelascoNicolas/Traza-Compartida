...
import com.entidades.buenSabor.repositories.ImagenEmpleadoRepository;
...
public class EmpleadoServiceImpl extends BaseServiceImp<Empleado, Long> implements EmpleadoService {
    ...
    @Autowired
    private ImagenEmpleadoRepository imagenRepo;
    ...
    public ResponseEntity<List<Map<String, Object>>> getAllImagesByEmpleadoId(Long id) {
        try {
            ...
            ImagenEmpleado images = empleadoRepository.getById(id).getImagenEmpleado();
    ...
    public ResponseEntity<String> uploadImages(MultipartFile[] files, Long idEmpleado) {
        List<String> urls = new ArrayList<>();
        var empleado = empleadoRepository.getById(idEmpleado);
        ...
        try {
            ...
            for (MultipartFile file : files) {
                ...
                ImagenEmpleado image = new ImagenEmpleado();
